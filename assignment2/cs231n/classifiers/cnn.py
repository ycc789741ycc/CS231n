...
class ThreeLayerConvNet(object):
    ...
    def __init__(
        ...
        conv1_out_dim = int(num_filters*input_dim[1]*input_dim[2]/4)
        self.params['W2'] = weight_scale*np.random.randn(conv1_out_dim,hidden_dim)
    ...
    def loss(self, X, y=None):
        ...
        dout,dw,db = affine_backward(dout,cache_affine2)
        grads['W3'] = dw + self.reg*W3
        grads['b3'] = db
        dout,dw,db = affine_relu_backward(dout,cache_affine1)
        grads['W2'] = dw + self.reg*W2
        grads['b2'] = db
        dout,dw,db = conv_relu_pool_backward(dout,cache_conv)
